...
<CardGroup cols={4}>
  <Card title="Source APIs" icon="plug">
    Procore, Sage, P6, and other connected systems
  </Card>
  <Card title="Kroo Pipeline" icon="arrow-right-arrow-left">
    Fetch, flatten, and normalize raw data
  </Card>
  <Card title="Data Warehouse" icon="database">
    Organized and structured tables
  </Card>
  <Card title="Analytics" icon="chart-bar">
    PowerBI dashboards and SQL reporting
  </Card>
</CardGroup>
...
- **`_fivetran_synced`** - Timestamp of when the record was last created or edited in the system
