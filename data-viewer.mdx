...
1. Log into your Kroo account at [app.kroo.com](https://getkroo.com)
...
<CodeGroup>
```text Autdesk Schema
kroo_autodesk/                  # Autodesk construction data
...
```mermaid
graph LR
    A[Source Systems] --> B[Kroo Syncing]
    B --> C[Kroo Data Viewer]
    B --> D[Power BI/Tableau]
```
