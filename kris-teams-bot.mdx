...
<Card title="Download Kris Teams Bot" icon="download" href="/teams-manifest.zip">
...
<Step title="Upload the app package">
  Click **Upload new app** at the top of the page, then click **Upload**. Select the `teams-manifest.zip` file you downloaded above.
